...
BubbleShoot.ui = (function($){
    var ui = {
        ...
        getBubbleCoords: function (bubble){
            var getBubbleCoords = bubble.position();
            getBubbleCoords.left += ui.BUBBLE_DIMS/2;
            getBubbleCoords.top += ui.BUBBLE_DIMS/2;
            return getBubbleCoords;
        },
        getBubbleAngle : function(bubble, e){
            ...
            var boardLeft = 120;
            console.log("Mouse x: " + mouseCoords.x + " mouse y: " + mouseCoords.y);
